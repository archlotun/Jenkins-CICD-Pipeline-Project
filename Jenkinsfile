...
pipeline {
    ...
    stage('SonarQube Scan') {
      steps {
        sh """mvn sonar:sonar \
              ...
              -Dsonar.host.url=http://172.31.94.171:9000 \
              -Dsonar.login=4c43bf7e0aadf34e0608c4adb901c6ecc4e9fe29"""
      }
    }
  ...
  post {
    always {
        ...
        slackSend channel: '#milotun-jenkins-pipeline-alert', //update and provide your channel name
